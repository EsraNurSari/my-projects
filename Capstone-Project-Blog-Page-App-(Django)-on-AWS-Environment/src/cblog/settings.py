...
DATABASES = {
    'default': {
        ...
        'NAME': 'capstoneprojectdb', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstone-project-db-instance.chmn9bg4g6bo.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-project-s3bucket'
